...
export const api = {
  ...
  createIdeationKickoff: (sessionId: string, expectedSessionRevision: number) => request<IdeationMessage>(`/ideation/sessions/${sessionId}/kickoff`, { method: "POST", body: JSON.stringify({ expectedSessionRevision }) }),
