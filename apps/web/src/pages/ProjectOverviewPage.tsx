...
export function ProjectOverviewPage() {
  ...
  const submit = async (event: FormEvent) => {
    ...
    setOpen(false); setTitle(""); selectProject(created.id); navigate("/incubator");
  };
